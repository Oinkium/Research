...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \item Now consider the rules
      ...
      This tells us that we can assume that $\Gamma$ is the empty context when we want to deal with these two cases.
      \begin{SidewaysFigure}
        \[
          \begin{tikzcd}[ampersand replacement=\&, column sep=5pt]
            ...
            {\oc\Varr \tensor \oc\V_{x,\Gamma}} \arrow[r, Isom, dotted] \arrow[d, "{\deno{x\ts M} \tensor \oc\V_{x,\Gamma}}"' {description, yshift=1pt}, dotted]
              \& \oc\Varr \tensor (\oc\Varr \tensor\oc\V_\Gamma) \arrow[urr, "{\assoc_{\oc\Varr,\oc\Varr,\oc\V_\Gamma}\inv}" {description, xshift=-5pt, yshift=5pt}, start anchor={[xshift=-25pt, dotted]}, bend left=5] \arrow[r, "\deno{x\ts M} \tensor (\oc\Varr\tensor\oc\V_\Gamma)" yshift=2pt, dotted]
        ...
        \begin{mathpar}
            ...
            I \arrow[r, "\oc s(x)"] \arrow[d, "\oc n" description] \arrow[dr, Rightarrow, no head]
              & \oc \bN \arrow[r, "\cell"] \arrow[d, "()" description] \arrow[dr, "\cell_0" description]
                & \oc\Varr \arrow[r, "\mu_{\Varr}"] \arrow[dd, "\alpha_{\Varr}" description, controls={+(1,-0.25) and +(0.8,0.75)}, start anchor={[yshift=-1pt]}, end anchor = {[xshift=25pt]}]
                  & \oc \Varr \tensor \oc \Varr \arrow[d, "\der_{\Varr} \tensor \oc\Varr" description]  \\
          ...
          \begin{tikzcd}[row sep=30pt]
            I \arrow[r, "\oc s(x)"] \arrow[d, "\oc s(x)" description] \arrow[dr]
              &[-31pt] \oc\bN \arrow[r, "\cell"] \arrow[dr, "\mu_\bN" description] \arrow[ddr, "\cell_0" {description, near end}, bend left=50]
                &[-100pt] \oc\Varr \arrow[r, "\mu_{\Varr}"] \arrow[ddd, "\alpha_{\Varr}" description]
                  &[-21pt] \oc\Varr \tensor \oc\Varr \arrow[d, "\der_{\Varr}\tensor\oc\Varr" description] \\
            |[alias=Z]| \oc\bN \arrow[d, "\lunit_{\oc\bN}" description] \arrow[dd, "\cell" description]
              & |[left=40pt of Z.east]| I \tensor I \arrow[dl, "I \tensor \oc s(x)" description] \arrow[r, "\oc s(x) \tensor \oc s(x)"] \arrow[d, "s(x)\tensor \oc s(x)" description]
                & |[left=50pt of Z.west]| \oc \bN \tensor \oc\bN \arrow[dl, "\der_\bN \tensor \oc\bN" description]
