...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \item Next, suppose that $\Gamma,\Delta,x\from S \ts M\from T$.  
      ...
      \begin{mathpar}
        \oc\V_\Gamma \xrightarrow{\langle\der,\sigma_1,\cdots,\sigma_n\rangle^\dag} \oc\V_{\Gamma,\Delta} \xrightarrow{\mu_{\V_{\Gamma,\Delta}}} \oc\V_{\Gamma,\Delta}\tensor\oc\V_{\Gamma,\Delta}\\ \xrightarrow{\deno{\Gamma,\Delta\ts \lambda x.M} \tensor (\sigma')^\dag} (\oc\deno S\implies \deno T) \tensor \oc\deno S \xrightarrow{\ev} \deno T\,.
      \end{mathpar}

      In the special case that $S=\Var$ and $T=X$ is a datatype, we need to show that we also have
      \begin{mathpar}
        \bigg(\oc\V_\Gamma \xrightarrow{\langle\der,\sigma_1,\cdots,\sigma_n\rangle^\dag}
        \oc\V_{\Gamma,\Delta} \xrightarrow{\runit_{\oc\V_{\Gamma,\Delta}}}
        \oc\V_{\Gamma,\Delta}\tensor I \xrightarrow{\oc\V_{\Gamma,\Delta} \tensor \oc0}
        \oc\V_{\Gamma,\Delta}\tensor\oc\bN \xrightarrow{\oc\V_{\Gamma,\Delta}\tensor\cell}
        \oc\V_{\Gamma,\Delta}\tensor\oc\Var \xrightarrow{\deno{\Gamma,\Delta\ts\lambda x.M}\tensor \oc\Var}\\
      ...
      \begin{mathpar}
        \left(
        \oc\V_{\Gamma,x} \xrightarrow{\langle\pr_\Gamma,\sigma_1,\cdots,\sigma_n,\pr_x\rangle^\dag}
        \oc\V_{\Gamma,\Delta,x} \xrightarrow{\deno{\Gamma,\Delta,x\ts M}}
        X
        \right)
      ...
      \begin{mathpar}
        \oc\V_\Gamma \xrightarrow{\langle\der,\sigma_1,\cdots,\sigma_n\rangle^\dag}
        \oc\V_{\Gamma,\Delta} \xrightarrow{\runit_{\oc\V_{\Gamma,\Delta}}}
        \oc\V_{\Gamma,\Delta}\tensor I \xrightarrow{\oc\V_{\Gamma,\Delta} \tensor \oc0}
        \oc\V_{\Gamma,\Delta}\tensor\oc\bN \xrightarrow{\oc\V_{\Gamma,\Delta}\tensor\cell}
