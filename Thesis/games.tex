...
We can generalize the subset inclusions of the previous section to \emph{tree immersions}.  
...
\begin{remark}
  ...
  The definitions we have used are similar: a \emph{strong action} is a lax action in which the coherences (called $m$ and $e$ in Chapter \ref{ChapParametricMonads} and $\passoc$ and $\run$ here) are isomorphisms.  
