...
Note that this result is not the sharpest possible, since they do not consider the case that there may be more complicated zigzags mediating between the morphisms.
