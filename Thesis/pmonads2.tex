...
Having fix a model $\G$ of Idealized Algol as above, suppose that the datatypes in $\G$ are interpreted via an oplax monoidal functor $\Set \to \G$.  
...
\begin{proposition}[{Compact Definability for \IAXX}]
  ...
  \[
    h \from j(p_1) \times \cdots \times j(p_n) \to x\,.
    \]
