...
\begin{definition}
  ...
  \begin{SidewaysFigure}
    \centering
    \begin{mathpar}
      \begin{tikzcd}[ampersand replacement=\&, column sep=116pt]
        ...
        \C_1(a_1,b_1),\cdots,\C_n(a_n,b_n),\C_1(b_1,c_1),\cdots,\C_n(b_n,c_n) \arrow[d, "F"']
          \& \\
        \D(F(a_1,\cdots,a_n),F(b_1,\cdots,b_n)),\D(F(b_1,\cdots,b_n),F(c_1,\cdots,c_n)) \arrow[r, "{;_{F(a_1,\cdots,a_n),F(b_1,\cdots,b_n),F(c_1,\cdots,c_n)}}" yshift=0.3em]
...
\begin{figure}
  \begin{mathpar}
    \begin{tikzcd}[column sep=21pt]
      {\C(a,a'),F_1(a',b_1),\cdots,F_n(b_{n-1},c),\C(c,c')} \arrow[r, "{\id,\phi_{a',\vec{b},c},\id}", xshift=-2ex, shorten=-1.8ex] \arrow[d, "{p,\id,\cdots,\id,p}"']
...
\subsection{The multicategory of functors}
