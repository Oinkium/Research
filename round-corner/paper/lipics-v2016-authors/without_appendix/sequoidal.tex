...
% Author macros::begin %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Sequoidal Categories and Transfinite Games: A Coalgebraic Approach to Stateful Objects in Game Semantics\footnote{This work was partially supported by UK EPSRC Grant EP/K037633/1.  Full version with appendix available at \cite{RoundCorner}.}}
...
\end{proposition}
\begin{proof}
    See Appendix to full version \cite{RoundCorner}
\end{proof}
