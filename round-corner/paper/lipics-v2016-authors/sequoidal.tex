...
% Author macros::begin %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Sequoidal Categories and Transfinite Games: A Coalgebraic Approach to Stateful Objects in Game Semantics\footnote{This work was partially supported by [TODO: find the appropriate grant codes]}}
...
In particular, $\oc A$ is the final coalgebra for $A\sequoid\blank$.  But, as we showed above, it is not the cofree commutative coalgebra over $A$.  
